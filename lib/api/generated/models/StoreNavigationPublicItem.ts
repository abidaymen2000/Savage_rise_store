...
import type { ResolvedStorePageDestination } from './ResolvedStorePageDestination';
...
export type StoreNavigationPublicItem = {
    ...
    icon?: (string | null);
    badge?: (string | null);
    destination: (ResolvedSystemRouteDestination | ResolvedStorePageDestination | ResolvedCatalogCategoryDestination | ResolvedCatalogProductDestination | InternalPathDestination | ExternalUrlDestination);
